 ...
 */
@Configuration
@ComponentScan(basePackages = {"com.example.http.tcp.server.poc.domain"})
@Import({HttpTcpServerPocInfraConfig.class, HttpTcpServerPocCodeListConfig.class})
public class HttpTcpServerPocDomainConfig {
