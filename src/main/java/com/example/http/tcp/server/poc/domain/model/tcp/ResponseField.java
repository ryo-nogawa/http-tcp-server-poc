...
public enum ResponseField {
     ...
     * リターンコードフィールド.
     *
     * <p>オフセット6、長さ1バイト、属性はBCD。
     */
    RETURN_CODE(6, 1, FieldType.BCD),

    /**
     * メッセージフィールド.
     *
     * <p>オフセット7、長さ46バイト、属性はTXT。
     */
    MESSAGE(7, 46, FieldType.TXT);
     ...
     */
    ResponseField(int offset, int length, FieldType fieldType) {
        this.offset = offset;
        this.length = length;
